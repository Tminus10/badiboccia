...
$router->get('/calendar.ics', ['CalendarController', 'feed']);
$router->get('/calendar', ['CalendarController', 'current']);
$router->get('/calendar/{id}', ['CalendarController', 'forSeason']);
...
$router->post('/admin/season/{id}/calendar-event', ['AdminController', 'calendarEventCreate']);
$router->post('/admin/calendar-event/{id}/update', ['AdminController', 'calendarEventUpdate']);
$router->post('/admin/calendar-event/{id}/delete', ['AdminController', 'calendarEventDelete']);
